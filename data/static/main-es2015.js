...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        ...
        this.store
            ...
            .subscribe(data => (this.data = data.chartDataResponse.chartDataResponses));
    }
};
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _ngrx_store__WEBPACK_IMPORTED_MODULE_7__["StoreModule"].forRoot(_store_reducers__WEBPACK_IMPORTED_MODULE_11__["reducers"], {
            ...
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_8__["EffectsModule"].forRoot([_store_effects_app_effects__WEBPACK_IMPORTED_MODULE_10__["AppEffects"]]),
...
/* harmony import */ var _store_actions_chart_data_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/actions/chart-data.actions */ "./src/app/store/actions/chart-data.actions.ts");
...
let FormComponent = class FormComponent {
    constructor(fb, store) {
        this.fb = fb;
        this.store = store;
        this.periods = [{ value: "Month" }, { value: "Year" }];
    }
    ngOnInit() {
...
let LineChartComponent = class LineChartComponent {
    ...
    createChart() {
        ...
        const svg = d3__WEBPACK_IMPORTED_MODULE_2__["select"](element)
            .append("svg")
            .attr("width", "100%")
            .attr("height", "100%");
        ...
        const xScale = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]()
            .domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](data, xValue))
            .range([0, innerWidth])
            .nice();
        const yScale = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]()
            .domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](data, yValue))
            .range([innerHeight, 0])
            .nice();
        const g = svg
            .append("g")
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadChartDataResponse", function() { return loadChartDataResponse; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setChartDataResponse", function() { return setChartDataResponse; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");


const loadChartDataResponse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[ChartDataResponse] Load ChartDataResponse");
const setChartDataResponse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[ChartDataResponse] Set ChartDataResponse", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadChartData", function() { return loadChartData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setChartData", function() { return setChartData; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");


const loadChartData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[ChartDataRequest] Load ChartData");
const setChartData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[ChartDataRequest] Set ChartData", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
/* harmony import */ var _actions_chart_data_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../actions/chart-data.actions */ "./src/app/store/actions/chart-data.actions.ts");
/* harmony import */ var _actions_chart_data_response_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../actions/chart-data-response.actions */ "./src/app/store/actions/chart-data-response.actions.ts");
/* harmony import */ var _reducers_chart_data_request_reducer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../reducers/chart-data-request.reducer */ "./src/app/store/reducers/chart-data-request.reducer.ts");
...
let AppEffects = class AppEffects {
    constructor(actions$, http, store) {
        ...
        this.http = http;
        this.store = store;
        this.setChartData$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_chart_data_actions__WEBPACK_IMPORTED_MODULE_6__["setChartData"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(this.store.select(_reducers_chart_data_request_reducer__WEBPACK_IMPORTED_MODULE_8__["selectFeatureChartData"])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(([value]) => {
            return this.http
                .post("./apitest/", {
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((chartDataResponses) => Object(_actions_chart_data_response_actions__WEBPACK_IMPORTED_MODULE_7__["setChartDataResponse"])({
                chartDataResponses
            })));
        })));
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chartDataFeatureKey", function() { return chartDataFeatureKey; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectFeatureChartData", function() { return selectFeatureChartData; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _actions_chart_data_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../actions/chart-data.actions */ "./src/app/store/actions/chart-data.actions.ts");



const chartDataFeatureKey = "chartData";
const initialState = {
...
const chartDataReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_chart_data_actions__WEBPACK_IMPORTED_MODULE_2__["setChartData"], (state, chartDataRequest) => (Object.assign({}, state, { startingCapitalAmount: chartDataRequest.startingCapitalAmount, additionAmount: chartDataRequest.additionAmount, returnPercentage: chartDataRequest.returnPercentage, numberOfPeriods: chartDataRequest.numberOfPeriods, typeOfPeriod: chartDataRequest.typeOfPeriod }))));
function reducer(state, action) {
    return chartDataReducer(state, action);
}
const selectFeature = (state) => state.feature;
const selectFeatureChartData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectFeature, (state) => state);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chartDataResponseFeatureKey", function() { return chartDataResponseFeatureKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialState", function() { return initialState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return reducer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectFeature", function() { return selectFeature; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectFeatureChartDataResponse", function() { return selectFeatureChartDataResponse; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _actions_chart_data_response_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../actions/chart-data-response.actions */ "./src/app/store/actions/chart-data-response.actions.ts");



const chartDataResponseFeatureKey = "chartDataResponse";
const initialState = {
    chartDataResponses: []
};
const chartDataResponseReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_chart_data_response_actions__WEBPACK_IMPORTED_MODULE_2__["setChartDataResponse"], (state, { chartDataResponses }) => (Object.assign({}, state, { chartDataResponses }))));
function reducer(state, action) {
    return chartDataResponseReducer(state, action);
}
const selectFeature = (state) => state.feature;
const selectFeatureChartDataResponse = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectFeature, (state) => state.chartDataResponses);
...
/* harmony import */ var _chart_data_request_reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chart-data-request.reducer */ "./src/app/store/reducers/chart-data-request.reducer.ts");
/* harmony import */ var _chart_data_response_reducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chart-data-response.reducer */ "./src/app/store/reducers/chart-data-response.reducer.ts");




const reducers = {
    [_chart_data_request_reducer__WEBPACK_IMPORTED_MODULE_2__["chartDataFeatureKey"]]: _chart_data_request_reducer__WEBPACK_IMPORTED_MODULE_2__["reducer"],
    [_chart_data_response_reducer__WEBPACK_IMPORTED_MODULE_3__["chartDataResponseFeatureKey"]]: _chart_data_response_reducer__WEBPACK_IMPORTED_MODULE_3__["reducer"]
};
...
module.exports = __webpack_require__(/*! C:\Users\groninge\Python\djangotest\testapp\src\main.ts */"./src/main.ts");
